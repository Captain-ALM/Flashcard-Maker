...
Public Class Preferences
    ...
    Private prefs As New List(Of IPreference(Of Object))
    ...
    Public Function getName() As String Implements IPreference(Of List(Of IPreference(Of Object))).getName
        Return nom
    End Function

    Public Sub loadPreference(data As String) Implements IPreference(Of List(Of IPreference(Of Object))).loadPreference
    ...
    Private Function getPreferenceIndex(name As String, Optional index As Integer = 0) As Integer
    ...
    Public Function savePreference() As String Implements IPreference(Of List(Of IPreference(Of Object))).savePreference
    ...
    Public Sub setName(name As String) Implements IPreference(Of List(Of IPreference(Of Object))).setName
        nom = name
    End Sub

    Public Function getPreference() As List(Of IPreference(Of Object)) Implements IPreference(Of List(Of IPreference(Of Object))).getPreference
    ...
    Public Function getPreference(Of t As IPreference(Of Object))(name As String, Optional index As Integer = 0) As t
        Dim indx As Integer = getPreferenceIndex(name, index)
        If indx < 0 Then Return Nothing
        Return prefs(indx)
    End Function

    Public Sub setPreference(pref As List(Of IPreference(Of Object))) Implements IPreference(Of List(Of IPreference(Of Object))).setPreference
    ...
    Public Sub setPreference(Of t As IPreference(Of Object))(pref As t, Optional index As Integer = 0)
